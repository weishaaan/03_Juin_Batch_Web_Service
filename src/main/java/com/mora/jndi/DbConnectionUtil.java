...
public class DbConnectionUtil {
    ...
    public static void init() {
        ...
        try {
            System.out.println(" ----------------- creating initial connection 1--------------------- ");
            dataSource = new ComboPooledDataSource();
            dataSource.setJdbcUrl("jdbc:mysql://localhost:3306/27juin");
...
//            dataSource.setUnreturnedConnectionTimeout(5);
            ...
            System.out.println(" --------------------- end initial connection --------------------- ");
